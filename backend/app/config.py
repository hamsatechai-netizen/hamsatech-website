...
class Settings:
    session_cookie_name: str = "hamsatech.ai_session"
    default_email: str = os.getenv("HAMSA_DEFAULT_EMAIL", "contact@hamsatech.ai")
    ...
    default_coach_code: str = os.getenv("HAMSA_DEFAULT_COACH_CODE", "C001")
