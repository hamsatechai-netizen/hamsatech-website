            ...
            <div className="tri-card">
              <div className="tri-icon">
                <svg width="80" height="80" viewBox="0 0 80 80">
                  ...
                  <path d="M 30 35 Q 30 25 35 25 Q 38 25 38 28 Q 41 25 44 27 Q 46 29 45 35 Q 48 36 47 40 Q 46 43 43 43 Q 42 46 38 46 Q 34 46 32 44 Q 28 42 28 38 Q 27 35 30 35 Z" 
                        fill="#4F89D8" opacity="0.8"/>
                </svg>
              </div>
            ...
            <div className="tri-card">
              <div className="tri-icon">
                <svg width="80" height="80" viewBox="0 0 80 80">
                  ...
                  <path d="M 40 30 Q 40 25 45 25 Q 50 25 50 30 Q 50 35 40 45 Q 30 35 30 30 Q 30 25 35 25 Q 40 25 40 30" 
