    ...
    <div className="usecases-page">
        ...
        <div className="container">
          <div className="usecase-content">
            <div className="usecase-image">
              <img src="/images/usecases/athlete.png" alt="Athlete performance plateau" />
            </div>
      ...
      <section className="usecase-detail featured-secondary">
        <div className="container">
          <div className="usecase-content reverse">
            <div className="usecase-image">
              <img src="/images/usecases/compat.png" alt="Pre-marriage compatibility assessment" />
            </div>
            <div className="usecase-text">
      ...
      <section className="usecase-detail alternate">
        <div className="container">
          <div className="usecase-content">
            <div className="usecase-image">
              <img src="/images/usecases/manager-dismissal.png" alt="Workplace dismissal stress" />
            </div>
            <div className="usecase-text">
      ...
      <section className="usecase-detail">
        <div className="container">
          <div className="usecase-content reverse">
            <div className="usecase-image">
              <img src="/images/usecases/mil-comment.png" alt="Family conflict trigger" />
            </div>
            <div className="usecase-text">
      ...
      <section className="usecase-detail alternate">
        <div className="container">
          <div className="usecase-content">
            <div className="usecase-image">
              <img src="/images/usecases/teen-fine.png" alt="Teen withdrawal signals" />
            </div>
            <div className="usecase-text">
      ...
      <section className="usecase-detail">
        <div className="container">
          <div className="usecase-content reverse">
            <div className="usecase-image">
              <img src="/images/usecases/exam-pressure.png" alt="Student exam stress" />
            </div>
            <div className="usecase-text">
